...
public class InsumoAgricola {
    ...
    // Construtor
    public InsumoAgricola(String nome, double precoPorUnidade, int estoque) {
        this.nome = nome;
    ...
    // Método para exibir as informações do insumo
    public void exibirInformacoes() {
        System.out.println("Insumo Agrícola: " + nome);
